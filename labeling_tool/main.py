...
class LabelerWindow(QWidget):
    ...
    def init_buttons(self):
        ...
        next_im_btn.clicked.connect(lambda state, filename=uuid.uuid1().hex: self.generate_csv(filename))
    ...
    def closeEvent(self, event):
        ...
        self.generate_csv(uuid.uuid1().hex)
